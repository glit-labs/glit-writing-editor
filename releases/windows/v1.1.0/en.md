---
description: "Glit Windows v1.1.0 release notes — the new features, improvements, and bug fixes in this update of the web novel writing app."
date: 2026-05-31
---
...
### Windows: Images Not Displayed in Editor

On Windows, images embedded in documents were not displayed in the editor. This is now fixed.
...
### Windows: Drag-and-Drop Shows Full Path as Workspace Name

On Windows, dropping a folder onto the app displayed the full file path as the workspace name instead of just the folder name. This is now fixed.

### Windows: Context Menu "Show in Folder" Label

The "Show in File Explorer" context menu item displayed an incorrect label in some languages on Windows. This is now fixed.
