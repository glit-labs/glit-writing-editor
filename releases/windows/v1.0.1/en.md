...
| Show in File Explorer | Reveal the item in the OS file manager |
...
* Removed the GitHub releases-based self-update checker (automatic banner and manual check button). Windows is distributed exclusively through the Microsoft Store; updates are handled automatically by the store.
